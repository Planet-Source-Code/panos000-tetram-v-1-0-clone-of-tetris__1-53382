...
Begin VB.Form Form1 
   ...
   Begin VB.PictureBox Picture4 
      ...
      Height          =   1485
      Left            =   2745
      MouseIcon       =   "form1.frx":261C4
      MousePointer    =   99  'Custom
      Picture         =   "form1.frx":26A96
      ScaleHeight     =   1455
      ScaleWidth      =   2820
      TabIndex        =   30
      Top             =   1485
   ...
   Begin VB.PictureBox Picture3 
      ...
      Height          =   1485
      Left            =   2745
      MouseIcon       =   "form1.frx":2BDAC
      MousePointer    =   99  'Custom
      Picture         =   "form1.frx":2C67E
      ScaleHeight     =   1455
      ScaleWidth      =   2820
      TabIndex        =   1
      Top             =   1485
   ...
   Begin VB.PictureBox Picture2 
      ...
      Height          =   1485
      Left            =   2745
      MouseIcon       =   "form1.frx":312C8
      MousePointer    =   99  'Custom
      Picture         =   "form1.frx":31B9A
      ScaleHeight     =   1455
      ScaleWidth      =   2820
      TabIndex        =   2
      Top             =   1485
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   1485
      Left            =   2745
      MouseIcon       =   "form1.frx":36B6A
      MousePointer    =   99  'Custom
      Picture         =   "form1.frx":3743C
      ScaleHeight     =   1455
      ScaleWidth      =   2820
      TabIndex        =   3
      Top             =   1485
...
MsgBox "Αν έχετε ενεργοποιημένη τη σύνδεση με το Internet, το tetRAM θα καταχωρήσει το Score σας στη γενική λίστα της RAMcomputer", vbInformation, App.Title
...
Dim aaa As String
aaa = InputBox("Παρακαλώ πληκτρολογήστε το όνομά σας", "High Score", "RAMcomputer")
rstpanos.Delete
rstpanos.AddNew
rstpanos!Name = aaa
...
Dim i As Integer
If MsgBox("Θα ξεκινήσετε από το Level " & StartLevel + 1 & ". Θέλετε να συνεχίσετε;", vbQuestion + vbYesNo, App.Title) = vbYes Then
BlocksCount = 0
LinesCount = 0
TeTram = 0
