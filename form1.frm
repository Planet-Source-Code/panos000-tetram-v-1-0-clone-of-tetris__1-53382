...
MsgBox "Áí Ý÷åôå åíåñãïðïéçìÝíç ôç óýíäåóç ìå ôï Internet, ôï tetRAM èá êáôá÷ùñÞóåé ôï Score óáò óôç ãåíéêÞ ëßóôá ôçò RAMcomputer", vbInformation, App.Title
...
Dim aaa As String
aaa = InputBox("Ðáñáêáëþ ðëçêôñïëïãÞóôå ôï üíïìÜ óáò", "High Score", "RAMcomputer")
rstpanos.Delete
rstpanos.AddNew
rstpanos!Name = aaa
...
Dim i As Integer
If MsgBox("Èá îåêéíÞóåôå áðü ôï Level " & StartLevel + 1 & ". ÈÝëåôå íá óõíå÷ßóåôå;", vbQuestion + vbYesNo, App.Title) = vbYes Then
BlocksCount = 0
LinesCount = 0
TeTram = 0
